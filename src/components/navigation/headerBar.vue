                         ...
                         <template v-for="item in navBar">
                              <template v-if="item.chiled">
                                  <el-submenu :index="item.id" popper-class="childMenu" :key="item.id" >
                                        <template slot="title">
                                            <i class="menu_icon" :class="item.icon"></i>{{ item.name }}
                                        </template>
                                        <el-menu-item 
                                        v-for="(subItem,i) in item.chiled" 
                                        :key="i" :index="subItem.path" 
                               ...
                               <template v-else>
                                       <el-menu-item :key="item.id" :index="item.path" :route='{ path: item.path }' >
                                          <template><span>
                                                    <i class="menu_icon" :class="item.icon"></i>{{ item.name }}
                                                </span>
                                           </template>
