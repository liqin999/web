...
export default {
    ...
    data () {
        return {
            ...
            content: `<p>新华社北京1月27日电（记者李忠发、潘洁）中共中央总书记、
                国家主席习近平和夫人彭丽媛27日在北京会见以朝鲜劳动党中央政治局委员、
                中央副委员长、国际部部长李洙墉为团长的朝鲜友好艺术团。</p>
                <p>习近平和彭丽媛欢迎朝鲜友好艺术团访华演出。习近平指出，此次访演既是落实中朝双方重要
                ...
                习近平请李洙墉转达对金正恩委员长和李雪主女士的亲切问候和良好祝愿。</p>
                <p>习近平指出，2018年以来，我同金正恩委员长4次会晤，就新时期中朝两党两国关系发展达成重要共识。今年是中朝建交70周年。
                ...
                继续为巩固中朝友好民意基础、传承中朝传统友谊、推动各自社会主义文化建设作出积极贡献。</p>
                <p>新华社北京1月27日电（记者李忠发、潘洁）中共中央总书记、
                国家主席习近平和夫人彭丽媛27日在北京会见以朝鲜劳动党中央政治局委员、
                中央副委员长、国际部部长李洙墉为团长的朝鲜友好艺术团。</p>
                <p>习近平和彭丽媛欢迎朝鲜友好艺术团访华演出。习近平指出，此次访演既是落实中朝双方重要
                共识的一项重要文化交流活动，也是中朝建交70周年一项重要庆祝活动。相信访演会取得圆满成功，
    ...
    computed: {
        setContentStyle () {
            return {
                ...
                'margin-left': this.params.leftSpace * 2.5 + 'px',
                'margin-right': this.params.leftSpace * 2.5 + 'px',
                'margin-top': this.params.topSpace * 2.5 + 'px',
                'margin-bottom': this.params.bottomSpace * 2.5 + 'px'
