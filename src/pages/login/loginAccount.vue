    ...
    <div class="login-account">
        ...
        <transition-group name='tran'
            ...
            <div class="login"
                ...
                <div class="input">
                    <el-input v-model="reqUser.userName"
                              prefix-icon="el-icon-ump-xingmingyonghumingnicheng"
                              placeholder="用户名"></el-input>
                    <el-input v-model="reqUser.password"
                              type="password"
                              prefix-icon="el-icon-ump-pwd"
                    ...
                    <div class="text clearfix">
                        ...
                        <el-button type="text"
                                   class="text-reg"
                                   @click="regUserIn()">立即注册</el-button>
                    </div>
                </div>
            </div>
            ...
            <div class="login forget"
                ...
                <div class="input">
                    <el-input v-model="regUser.userName"
                              prefix-icon="el-icon-ump-xingmingyonghumingnicheng"
                              placeholder="用户名"></el-input>
                    <el-input v-model="regUser.realName"
                              prefix-icon="el-icon-ump-xingmingyonghumingnicheng"
                              placeholder="昵称"></el-input>
                    <el-input v-model="regUser.password"
                              type="password"
                              prefix-icon="el-icon-ump-pwd"
                              placeholder="密码"></el-input>
                    <el-input v-model="confirmPass"
                              type="password"
                              prefix-icon="el-icon-ump-pwd"
...
export default {
    data () {
        return {
            ...
            confirmPass: '',     // 确认密码
            slideshowImages: [                      // 登录页相关图片
                {
                    src: require('../../assets/img/login/loginA1.jpg')
                },
                {
                    src: require('../../assets/img/login/loginA2.jpg')
                },
                {
                    src: require('../../assets/img/login/loginA3.jpg')
                },
                {
                    src: require('../../assets/img/login/loginA4.jpg')
                }
            ]
        }
    },
